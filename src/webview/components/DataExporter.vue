    ...
    >
      <div class="export-content">
        ...
        >
          ...
          >
            <el-radio-button label="waveform">
              波形数据
            </el-radio-button>
            <el-radio-button label="decoder">
              解码结果
            </el-radio-button>
        ...
        >
          ...
          >
            ...
            <el-form-item
              v-if="exportOptions.timeRange === 'custom'"
              label="自定义范围"
            >
            ...
            <template v-if="exportType === 'waveform'">
              ...
              <el-form-item label="采样模式">
                <el-radio-group v-model="exportOptions.samplingMode">
                  ...
                  <el-radio label="compressed">
                    压缩数据
                  </el-radio>
                  <el-radio label="interpolated">
                    插值数据
                  </el-radio>
                </el-radio-group>
              </el-form-item>
            ...
            <template v-if="exportType === 'decoder'">
              ...
              <el-form-item label="包含详情">
                <el-checkbox-group v-model="exportOptions.includeDetails">
                  ...
                  <el-checkbox label="raw_data">
                    原始数据
                  </el-checkbox>
                  <el-checkbox label="annotations">
                    注释信息
                  </el-checkbox>
            ...
            <template v-if="exportType === 'analysis'">
              <el-form-item label="报告内容">
                <el-checkbox-group v-model="exportOptions.reportSections">
                  ...
                  <el-checkbox label="recommendations">
                    优化建议
                  </el-checkbox>
            ...
            <el-form-item label="高级选项">
              <el-checkbox-group v-model="exportOptions.advancedOptions">
                <el-checkbox label="compress">
                  启用压缩
                </el-checkbox>
                <el-checkbox label="metadata">
                  包含元数据
                </el-checkbox>
                <el-checkbox label="checksum">
                  添加校验和
                </el-checkbox>
                <el-checkbox label="split_files">
                  大文件分割
                </el-checkbox>
              </el-checkbox-group>
            </el-form-item>
