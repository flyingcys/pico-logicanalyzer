  ...
  <div class="device-manager">
    ...
    <div class="device-header">
      ...
      <div class="device-actions">
        ...
        <el-button type="success" :icon="Plus" @click="showAddDeviceDialog = true" size="small">
          添加设备
        </el-button>
      </div>
    </div>
      ...
      <el-card shadow="never" class="device-card current">
        ...
        <div class="device-info">
          <div class="device-main">
            <h4 class="device-name">{{ currentDevice.name }}</h4>
            <p class="device-desc">{{ currentDevice.version }}</p>
          ...
          <div class="device-status-info">
            ...
            <div v-if="currentDevice.isNetwork" class="status-item">
    ...
    <div class="available-devices">
      ...
      <div v-if="filteredDevices.length === 0" class="no-devices">
        <el-empty :image-size="80" description="暂无可用设备">
          <el-button type="primary" :icon="Refresh" @click="scanDevices"> 扫描设备 </el-button>
        </el-empty>
      </div>
        ...
        >
          <div class="device-info">
            <div class="device-main">
              <div class="device-header-info">
                ...
                <div class="device-badges">
                  <el-tag v-if="device.isNetwork" size="small" type="info"> 网络 </el-tag>
                  <el-tag v-if="!device.available" size="small" type="danger"> 不可用 </el-tag>
                </div>
              </div>
            ...
            <div class="device-actions-row">
              ...
              <el-button size="small" @click.stop="showDeviceInfo(device)"> 详情 </el-button>
            </div>
          </div>
        </el-card>
      </div>
    ...
    <el-dialog v-model="showAddDeviceDialog" title="添加设备" width="500px">
      <el-form :model="newDeviceForm" label-width="80px">
        <el-form-item label="设备类型">
          <el-select v-model="newDeviceForm.type" placeholder="选择设备类型">
            <el-option label="网络设备" value="network" />
            <el-option label="串口设备" value="serial" />
            <el-option label="模拟设备" value="emulated" />
          </el-select>
        </el-form-item>

        <template v-if="newDeviceForm.type === 'network'">
          <el-form-item label="IP地址">
            <el-input v-model="newDeviceForm.ipAddress" placeholder="192.168.1.100" />
          </el-form-item>
          <el-form-item label="端口">
            <el-input-number v-model="newDeviceForm.port" :min="1" :max="65535" />
          </el-form-item>
        </template>

        <template v-if="newDeviceForm.type === 'serial'">
          <el-form-item label="串口">
            <el-select v-model="newDeviceForm.serialPort" placeholder="选择串口">
              <el-option
    ...
    <el-dialog
      ...
      width="600px"
    >
      <div v-if="selectedDeviceForInfo" class="device-detail">
        ...
        <div v-if="selectedDeviceForInfo.capabilities" class="capabilities-section">
          <h4>设备能力</h4>
