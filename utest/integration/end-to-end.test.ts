...
describe('端到端集成测试', () => {
    ...
    describe('单设备完整流程测试', () => {
        ...
        it('设备连接 -> SPI数据采集 -> SPI解码 -> 数据导出', async () => {
            // 1. 配置SPI采集
